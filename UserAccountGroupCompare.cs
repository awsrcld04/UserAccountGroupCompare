...
namespace UserAccountGroupCompare
{
    class UAGC2Main
    {
        struct CMDArguments
        ...
        {
            Console.WriteLine("Parameters must be specified to run UserAccountGroupCompare.");
            Console.WriteLine("Run UserAccountGroupCompare -? to get the parameter syntax.");
        }
        ...
        static void funcPrintParameterSyntax()
        {
            ...
            Console.WriteLine("-check:[UserName]             specify user to check");
            Console.WriteLine();
            Console.WriteLine("Examples:");
            Console.WriteLine("UserAccountGroupCompare -run -ref:User1 -check:User2");
        }
                    ...
                    if (cmdargs[1].Contains("-ref:"))
                    {
                        ...
                        if (bCmdArg1Complete & cmdargs.Length > 2)
                        {
                            if (cmdargs[2].Contains("-check:"))
                            {
                                ...
                                objCMDArguments.strCheckUser = cmdargs[2].Substring(7);
        ...
        static void funcWriteToErrorLog(string strErrorMessage)
        {
            try
            {
                FileStream newFileStream = new FileStream("Err-UserAccountGroupCompare.log", FileMode.Append, FileAccess.Write);
